...
class ImageUploadProvider {
  ...
  Future<dynamic> callDeliveredShipmentImageApi({g.Rx<File>? shipmentImage, String? shipment_id,Map<String, String>? headers}) async {
    ...
    FormData formData = FormData.fromMap({
      ...
      'delivered_shipment_image[]' : await MultipartFile.fromFile(shipmentImage.value.path, filename: fileName)
    });
    try{
      Response response = await Dio().post(Api.shipmentDeliveryImageUpload,
          data: formData,
          options: Options(
